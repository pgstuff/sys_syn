...
SELECT  out_queue.key,  out_queue.delta_type,   out_queue.queue_state,
        (in_data.key).*,        (in_data.attributes).*
...
UPDATE user_data.test_table SET test_table_text = 'test_data_1 v2' WHERE test_table_key = 1;
...
DELETE FROM user_data.test_table WHERE test_table_key = 2;
